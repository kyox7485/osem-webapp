...
export const dictPhysio: Record<string, string> = {
  ...
  Branch: "Cawangan",
  Therapist: "Ahli Fisioterapi",
  "All therapists": "Semua ahli fisioterapi",
  "Total credit hours": "Jumlah Jam Kredit",
  "Outpatient (walk-in)": "Pesakit Luar (jalan masuk)",
  Housecall: "Lawatan Rumah",
  "Credit hours over time": "Jam Kredit Mengikut Masa",
  "No assessments in this period.": "Tiada penilaian dalam tempoh ini.",
  "Patient-type mix": "Campuran Jenis Pesakit",
  "Credit hours by branch": "Jam Kredit Mengikut Cawangan",
  "Team workload by branch": "Beban Kerja Pasukan Mengikut Cawangan",
  "Therapist workload & strength": "Beban Kerja & Kekuatan Ahli Fisioterapi",
  Baseline: "Garis Asas",
  week: "minggu",
  "overtime is expected, not flagged": "kerja lebih masa dijangka, bukan isu",
  "Team workload vs baseline": "Beban Kerja Pasukan vs Garis Asas",
  "Workload vs baseline": "Beban Kerja vs Garis Asas",
  "Total hours": "Jumlah Jam",
  Branches: "Cawangan-cawangan",
  "Failed to load dashboard data": "Gagal memuatkan data papan pemuka",
  "of total": "daripada jumlah",
  "total credit hours": "jumlah jam kredit",
  "{h}h/wk avg": "{h}j/mgu purata",
  "+{h}h overtime": "+{h}j kerja lebih masa",
  "{h}h below baseline": "{h}j di bawah garis asas",
