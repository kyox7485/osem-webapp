...
export const dictMedication: Record<string, string> = {
  ...
  "Countable balances are a forecast from the medication order since the last stock entry, not a physical count. Estimate units show the last counted quantity.": "Baki boleh kira ialah ramalan daripada pesanan ubat sejak entri stok terakhir, bukan kiraan fizikal. Unit anggaran menunjukkan kuantiti kiraan terakhir.",
