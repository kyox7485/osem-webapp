    ...
    <div className="mb-4 space-y-3 rounded-md border border-gray-200 bg-white p-4 shadow-sm">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        {period === "custom" && (
          <>
            <div>
              <label className="mb-1 block text-xs font-medium text-gray-700">{t("Start date")}</label>
              <input
                type="date"
                value={start}
            ...
            <div>
              <label className="mb-1 block text-xs font-medium text-gray-700">{t("End date")}</label>
              <input
                type="date"
                value={end}
        ...
        {view === "individual" && (
          <div>
            <label className="mb-1 block text-xs font-medium text-gray-700">{t("Therapist")}</label>
            <select
              value={therapist}
