...
export function CollapsibleCard({ title, badge, children }: Props) {
  ...
  return (
    <details
      ...
      className="group rounded-md border border-line bg-surface shadow-sm"
    >
      <summary className="flex cursor-pointer list-none items-center justify-between px-4 py-3 hover:bg-hover">
      ...
      <div className="border-t border-line-subtle p-4">{children}</div>
    </details>
  );
}
