                  ...
                  >
                    ...
                    {isExpanded && (
                      <div className="mt-3 space-y-2 border-t border-gray-100 pt-3">
                        ...
                        {entry.respiration_rate !== null && (
                          <p className="text-sm text-gray-600">
                            <span className="font-medium text-gray-500">Respiration rate: </span>
                            {entry.respiration_rate}
                          </p>
                        )}
                        {entry.gcs_label && (
                          <p className="text-sm text-gray-600">
                            <span className="font-medium text-gray-500">GCS: </span>
                            {entry.gcs_label}
                          </p>
                        )}
                        {entry.avpu_label && (
                          <p className="text-sm text-gray-600">
                            <span className="font-medium text-gray-500">AVPU: </span>
                            {entry.avpu_label}
                          </p>
                        )}
                        {entry.intervention && (
                    ...
                    <div className="mt-2 text-xs text-gray-400">
                      Entered by: {entry.created_by_name}
                      {entry.reviewed_by_name && <span> · Reviewed by: {entry.reviewed_by_name}</span>}
                    </div>
                  </div>
                );
              })
