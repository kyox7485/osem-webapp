...
function YesNoToggle({
  ...
  const inactive = "bg-white dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/60";
  return (
...
const sectionCls = "rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm space-y-4";
  ...
  return (
    <div className="space-y-4" onChangeCapture={markDirty}>
      ...
      <div className={sectionCls}>
        ...
        <div>
          <label className={labelCls}>{t("Active Issue")} <span className="text-xs font-normal text-gray-500 dark:text-gray-400">({t("why is this resident being monitored?")})</span></label>
          <textarea
            value={activeIssue}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className={sectionCls}>
          <h3 className="text-sm font-bold text-gray-900 dark:text-gray-100">{t("Nursing Assessment")}</h3>
          ...
          {/* Behavior */}
          <div>
            <label className={labelCls}>🧠 {t("Behavior")} <span className="text-xs font-normal text-gray-500 dark:text-gray-400">({t("select all that apply")})</span></label>
        ...
        <div className={sectionCls}>
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold text-gray-900 dark:text-gray-100">{t("Vital Signs")}</h3>
            {vitalsLoading && <span className="text-xs text-gray-400 dark:text-gray-500">{t("Loading latest vitals...")}</span>}
            {!vitalsLoading && residentId && (
              <span className="text-xs text-gray-400 dark:text-gray-500">{t("Pre-filled from latest record — edit if different")}</span>
            )}
          </div>
