    ...
    <div className="space-y-4" onChangeCapture={markDirty}>
      <div>
        ...
        <select
          ...
          required
          className="w-full max-w-md rounded-md border border-gray-300 dark:border-gray-700 px-3 py-2 text-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
        >
      ...
      {residentId && particularsLoading && (
        <p className="text-sm text-gray-400 dark:text-gray-500">{t("Loading resident particulars...")}</p>
      )}

      {residentId && particulars && (
        <details className="group rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm" open>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm">
        {error && <div className="rounded-md bg-red-50 dark:bg-red-950/40 p-3 text-sm text-red-800">{error}</div>}

        <div>
          <label htmlFor="chief-complaints" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
        ...
        <div>
          <h3 className="mb-2 text-sm font-semibold text-gray-800 dark:text-gray-200">{t("Vital Signs")}</h3>
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
            <div>
              <label htmlFor="systolic-bp" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                {t("BP Systolic")}
              </label>
              <input
                type="number"
            ...
            <div>
              <label htmlFor="diastolic-bp" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                {t("BP Diastolic")}
              </label>
              <input
                type="number"
            ...
            <div>
              <label htmlFor="heart-rate" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                {t("HR")}
              </label>
              <input
                type="number"
            ...
            <div>
              <label htmlFor="temperature" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                {t("Temp (°C)")}
              </label>
              <input
                type="number"
            ...
            <div>
              <label htmlFor="spo2" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                {t("SpO2 (%)")}
              </label>
              <input
                type="number"
            ...
            {spo2 && (
              <div>
                <label htmlFor="spo2-condition" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
            ...
            <div>
              <label htmlFor="dxt" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                {t("DXT (mmol/L)")}
              </label>
              <input
                type="number"
            ...
            {dxt && (
              <div>
                <label htmlFor="dxt-remark" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
          ...
          <div className="mt-3">
            ...
            >
              <svg
                ...
                viewBox="0 0 16 16"
                fill="none"
                className={`text-gray-400 dark:text-gray-500 transition-transform ${advancedObsOpen ? "rotate-90" : ""}`}
              >
                <path d="M6 3.5L10.5 8L6 12.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-200">{t("Advanced Observation")}</h3>
            </button>
            {advancedObsOpen && (
              <div className="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  <label htmlFor="respiration-rate" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                ...
                <div>
                  <label htmlFor="avpu" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                    {t("AVPU")}
                  </label>
                  <select
                    id="avpu"
                ...
                <div>
                  <label htmlFor="gcs-eye" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                    {t("GCS Eye")}
                  </label>
                  <select
                    id="gcs-eye"
                ...
                <div>
                  <label htmlFor="gcs-verbal" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                    {t("GCS Verbal")}
                  </label>
                  <select
                    id="gcs-verbal"
                ...
                <div>
                  <label htmlFor="gcs-motor" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                    {t("GCS Motor")}
                  </label>
                  <select
                    id="gcs-motor"
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <div>
            <label htmlFor="mobility" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
              {t("Mobility")}
            </label>
            <select
              id="mobility"
              ...
              disabled={!residentId}
              className="w-full rounded-md border border-gray-300 dark:border-gray-700 px-3 py-2 text-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 disabled:bg-gray-100"
            >
          ...
          <div>
            <label htmlFor="feeding" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
              {t("Feeding")}
            </label>
            <select
              id="feeding"
          ...
          <div>
            <label htmlFor="hygiene" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
              {t("Hygiene")}
            </label>
            <select
              id="hygiene"
        ...
        <div>
          <label htmlFor="reviewed-by" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
...
function ParticularField({ label, value, multiline }: { label: string; value: string | null; multiline?: boolean }) {
  ...
  return (
    <div>
      ...
      <dd className={`text-sm text-gray-800 dark:text-gray-200 ${multiline ? "whitespace-pre-wrap" : ""}`}>{value || t("None recorded.")}</dd>
    </div>
  );
}
