    ...
    <div className="mb-4 space-y-3 rounded-md border border-line bg-surface p-4 shadow-sm">
      ...
      <div className={`grid gap-3 ${isCustom ? "grid-cols-1 sm:grid-cols-3" : "grid-cols-1 sm:grid-cols-2 md:grid-cols-3"}`}>
        {isCustom && (
          <>
            <div>
              <label className="mb-1 block text-xs font-medium text-fg-secondary">{t("From date")}</label>
              <input
                type="date"
                value={from}
            ...
            <div>
              <label className="mb-1 block text-xs font-medium text-fg-secondary">{t("To date")}</label>
              <input
                type="date"
                value={to}
