...
export function SubjectiveSection({
  ...
  return (
    <div className="space-y-3 rounded-md border border-gray-200 bg-white p-4 shadow-sm">
      <h2 className="text-sm font-bold text-gray-900">Subjective Assessment</h2>
      ...
      <label className="block text-sm text-gray-700">
        Past Medical History <span className="font-normal text-gray-400">(from resident record)</span>
